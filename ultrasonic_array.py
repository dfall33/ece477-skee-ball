...
class UltrasonicArray:
    ...
    def __init__(
        ...
        self._GAP_TIME_US = 100000
        self._TIMEOUT_MS = int(1000 * timeout_seconds)
        self._TIMEOUT_TIMER_NUMBER = timeout_timer_number
        self._DURATION_THRESHOLD_US = threshold_cm * 1e4 / self._SOUND_SPEED # cm /= 100 = meters, meters / speed of sound = seconds, seconds * 1e6 = us, so us = 1e6/100/speed = 1e4 /speed
        ...
        self.timeout_timer.init(mode=Timer.ONE_SHOT, period=self._TIMEOUT_MS, callback=self._timeout_isr)
